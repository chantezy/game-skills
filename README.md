...
| 技能 | 定位 | 触发条件 |
|------|------|---------|
| game-creative-discussion | 游戏创意框架完善工具(三层递进) | 有一个游戏创意想法需要讨论、打磨、扩展为游戏创意框架,或某个模块设计前需要先完善框架,或需要做玩家分析/动机分析/设备适配/模块互联方向等策略规划 |
